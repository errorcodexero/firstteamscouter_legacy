...
public class MatchNotesDBAdapter implements BaseColumns {
     ...
     */
    public MatchNotesDBAdapter(Context ctx) {
        this.mCtx = ctx;
    }
     ...
     */
    public MatchNotesDBAdapter open() throws SQLException {
     ...
     */
    public boolean deleteMatchNote(long rowId) {
     ...
     */
    public Cursor getMatchNote(long rowId) throws SQLException {
