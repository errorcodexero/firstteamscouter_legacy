...
public class DBAdapter {
    ...
    private static final String[][] TABLE_LIST = {
		...
		
    	{
    		...
    		TeamMatchDBAdapter.COLUMN_NAME_SHORT_PASS_SUCCESS + INT_TYPE + COMMA_SEP +
    		TeamMatchDBAdapter.COLUMN_NAME_SHORT_PASS_MISS + INT_TYPE + COMMA_SEP +
    		TeamMatchDBAdapter.COLUMN_NAME_LONG_PASS_SUCCESS + INT_TYPE + COMMA_SEP +
    		TeamMatchDBAdapter.COLUMN_NAME_LONG_PASS_MISS + INT_TYPE + COMMA_SEP +
